...
export default function ClientTestimonialsSection() {
  ...
  return (
    <>
      ...
      <div className="relative mt-[138px] h-[714px] lg:h-auto md:h-auto">
        <Img
          src="images/img_element_amber_200.svg"
          alt="Secondary Image"
          className="mt-[30px] h-[46px] w-[12%] object-contain"
        />
        <div className="container-xl absolute bottom-0 left-0 right-0 top-0 my-auto flex h-max flex-col items-center gap-[54px] lg:px-5 md:px-5 sm:gap-[27px]">
          <Heading
            size="heading5xl"
            as="h2"
            className="text-[70px] font-bold text-gray-900 lg:text-[48px] md:text-[48px]"
          >
              ...
              items={[...Array(9)].map(() => (
                <React.Fragment key={Math.random()}>
                  <div className="px-[15px]">
                    <div className="flex flex-col gap-[60px] rounded-[10px] bg-white-a700 px-10 py-[60px] shadow-lg md:py-5 sm:gap-[30px] sm:p-4">
                      <div className="flex flex-col gap-8 border-b border-solid border-gray-900">
                        ...
                        <Text
                          as="p"
                          className="mb-10 text-[18px] font-normal leading-[30px] tracking-[-0.36px] text-gray-900 lg:text-[15px]"
                        >
                          Whitepate is designed as a collaboration tool for businesses that is a full project management
                          solution.
                        </Text>
                      </div>
                      <div className="mr-2 flex justify-between gap-5 md:mr-0 sm:flex-col">
                        <Img
                        ...
                        <div className="flex w-[64%] flex-col items-start gap-3 sm:w-full">
                          ...
                          <Text
                            ...
                            as="p"
                            className="w-full text-[16px] font-normal leading-5 tracking-[-0.32px] text-gray-900 lg:text-[13px]"
                          >
