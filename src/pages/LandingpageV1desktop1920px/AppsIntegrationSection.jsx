...
export default function AppsIntegrationSection() {
  return (
    <>
      ...
      <div className="relative mt-[140px] h-[750px] content-center bg-indigo-900 py-2 lg:h-auto md:h-auto">
          ...
          <div className="relative h-[470px] w-[46%] md:w-full">
            <div className="absolute left-0 right-0 top-0 mx-auto flex w-[70%] flex-col items-start">
              <div className="flex flex-col items-start self-stretch">
                <div className="relative z-[5] ml-[148px] flex flex-col items-center rounded-[36px] bg-white-a700 p-3.5 md:ml-0">
                ...
                <div className="relative mt-[-38px] flex items-center self-stretch">
                  <div className="relative z-[4] flex flex-col items-center rounded-[36px] bg-white-a700 p-3.5">
            ...
            <div className="absolute bottom-[0.20px] left-0 right-0 z-[6] mx-auto flex flex-1 items-start sm:relative sm:flex-col">
              <div className="flex w-[76%] items-start self-center sm:w-full sm:flex-col">
                <div className="relative z-[7] mt-24 flex flex-col items-center rounded-[36px] bg-white-a700 p-3.5">
              ...
              <div className="relative ml-[-36px] mt-24 flex flex-col items-center rounded-[36px] bg-white-a700 p-3.5 sm:ml-0">
                <Img src="images/img_google_drive.svg" alt="Drive Image" className="h-[42px]" />
              </div>
            </div>
          </div>
