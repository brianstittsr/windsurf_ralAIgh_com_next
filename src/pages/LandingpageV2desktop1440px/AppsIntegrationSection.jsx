    ...
    <>
      ...
      <div className="mt-[140px]">
        <div className="bg-indigo-900 py-2">
          <div className="mb-[30px] flex h-[700px] items-end bg-[url(/public/images/img_element_gray_500.png)] bg-cover bg-no-repeat px-8 py-[98px] md:h-auto md:py-5 sm:p-5">
            <div className="container-md mt-[30px] flex items-center md:flex-col">
