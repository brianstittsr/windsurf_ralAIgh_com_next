          ...
          <div className="mb-[76px] flex flex-col items-start gap-[60px] sm:gap-[30px]">
            <div className="flex flex-col items-start gap-[22px] self-stretch">
              <Heading
                size="header_h2"
                as="h1"
                className="w-[50%] text-[64px] font-bold leading-[77px] tracking-[-1.28px] text-blue-400 md:w-full md:text-[48px]"
              >
                Get More Done with whitepace
              </Heading>
              <Text
                as="p"
                className="w-[50%] text-[18px] font-normal leading-[30px] tracking-[-0.36px] text-blue-400 md:w-full"
              >
