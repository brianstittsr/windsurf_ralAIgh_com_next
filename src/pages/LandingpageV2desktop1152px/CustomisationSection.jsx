        ...
        <div className="flex flex-1 flex-col items-start gap-[60px] md:self-stretch sm:gap-[30px]">
          <div className="relative h-[268px] content-end self-stretch md:h-auto">
            <Img
              ...
              alt="Feature Image"
              className="mb-[108px] ml-[152px] h-[28px] w-[44%] object-contain md:ml-0"
            />
            <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 flex-col items-start gap-[22px]">
              ...
              <Text
                as="p"
                className="w-[84%] text-[18px] font-normal leading-[30px] tracking-[-0.36px] text-gray-900 md:w-full"
              >
