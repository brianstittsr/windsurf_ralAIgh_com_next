...
export default function SponsorsSection() {
  return (
    <>
      {/* sponsors section */}
      <div className="relative mt-[280px] h-[258px] lg:h-auto md:h-auto">
        <Img
          src="images/img_element_amber_200.svg"
          alt="Image Element"
          className="mt-14 h-[42px] w-[16%] object-contain"
        />
        <div className="container-xl absolute bottom-0 left-0 right-0 top-0 my-auto flex h-max flex-col items-center justify-center gap-[86px] lg:gap-[86px] lg:px-5 md:gap-16 md:px-5 sm:gap-[43px]">
          <Heading
            as="h1"
